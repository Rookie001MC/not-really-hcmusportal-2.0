...
void ScoreView::Init()
{
    ...
    _title.setString(
        "No      Student ID       Full Name                                Midterm      Final      "
        "   Other");
    ...
    while (!file.eof())
    {
        ...
        _mterm[cur].setOrigin(sf::Vector2f(_mterm[cur].getGlobalBounds().width / 2,
                                           _mterm[cur].getGlobalBounds().height / 2));
        ...
        _final[cur].setOrigin(sf::Vector2f(_final[cur].getGlobalBounds().width / 2,
                                           _final[cur].getGlobalBounds().height / 2));
        ...
        _other[cur].setOrigin(sf::Vector2f(_other[cur].getGlobalBounds().width / 2,
                                           _other[cur].getGlobalBounds().height / 2));
