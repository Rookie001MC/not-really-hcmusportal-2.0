...
CreateYear::CreateYear(Data *data)
    : _data(data),
      _boxfocus(0),
      _blink(1),
      _exitfocus(0),
...
void CreateYear::Init()
{
    ...
    _showbox.setPosition(_data->_window->getSize().x / 2 - 145,
    ...
    _example.setPosition(_data->_window->getSize().x / 2 - 145,
                         _data->_window->getSize().y / 2 - 115);
...
void Create::Init()
{
    ...
    _example.setPosition(_data->_window->getSize().x / 2 - 150,
                         _data->_window->getSize().y / 2 - 115);
    _example.setFillColor(sf::Color::Color(0, 0, 0, 50));
}
...
AddStudent::AddStudent(Data *data)
    : _data(data), _blink(1), _exitfocus(0), _submitfocus(0), _exitselected(0), _submitselected(0)
{}
...
void AddStudent::Init()
{
    ...
    for (int i = 0; i < 7; i++)
    {
        ...
        _box[i].setOrigin(sf::Vector2f(_box[i].getGlobalBounds().width / 2,
                                       _box[i].getGlobalBounds().height / 2));
        _box[i].setPosition(_data->_window->getSize().x / 2,
                            _data->_window->getSize().y / 2 - 350 + 90 * i);
        ...
        _text[i].setPosition(_data->_window->getSize().x / 2 - 150,
                             _data->_window->getSize().y / 2 - 410 + 90 * i);
        ...
        _showbox[i].setPosition(_data->_window->getSize().x / 2 - 150,
                                _data->_window->getSize().y / 2 - 365 + 90 * i);
...
void AddStudent::ProcessInput()
{
    ...
    while (_data->_window->pollEvent(event))
    {
        ...
        if (sf::Mouse::isButtonPressed(sf::Mouse::Left))
        {
            for (int i = 0; i < 7; i++)
            {
                _boxfocus[i] = (_box[i].getGlobalBounds().contains(
                                    sf::Vector2f(sf::Mouse::getPosition(*_data->_window).x,
                                                 sf::Mouse::getPosition(*_data->_window).y))
                                    ? 1
                                    : 0);
...
CreateSemester::CreateSemester(Data *data)
    : _data(data), _blink(1), _exitfocus(0), _submitfocus(0), _exitselected(0), _submitselected(0)
{}
...
void CreateSemester::Init()
{
    ...
    for (int i = 0; i < 4; i++)
    {
        ...
        _box[i].setOrigin(sf::Vector2f(_box[i].getGlobalBounds().width / 2,
                                       _box[i].getGlobalBounds().height / 2));
        _box[i].setPosition(_data->_window->getSize().x / 2,
                            _data->_window->getSize().y / 2 - 350 + 120 * i);
        _box[i].setOutlineThickness(1);
        _box[i].setOutlineColor(sf::Color(40, 116, 166, 240));

        _text[i].setFont(_data->_assets->GetFont(CHIVOMONO_LIGHT));
        _text[i].setCharacterSize(25);
        _text[i].setPosition(_data->_window->getSize().x / 2 - 200,
                             _data->_window->getSize().y / 2 - 410 + 120 * i);
        _text[i].setFillColor(sf::Color::Black);

        _showbox[i].setFont(_data->_assets->GetFont(LIGHT));
        _showbox[i].setCharacterSize(24);
        _showbox[i].setFillColor(sf::Color::Black);
        _showbox[i].setPosition(_data->_window->getSize().x / 2 - 195,
                                _data->_window->getSize().y / 2 - 365 + 120 * i);
        _showbox[i].setString("");
    }
...
void CreateSemester::Update()
{
    ...
    if (_submitselected || sf::Keyboard::isKeyPressed(sf::Keyboard::Enter))
    {
        ...
        s.close();
        std::string get = std::to_string(n + 1) + ".Semester " + _getbox[0] + "(" + _getbox[1] +
                          ")/(" + _getbox[2] + " - " + _getbox[3] + ")";
        std::string get1 =
            std::to_string(n + 1) + ".Semester " + _getbox[0] + "(" + _getbox[1] + ")";
...
void AddCourse::Init()
{
    ...
    for (int i = 0; i < 8; i++)
    {
        ...
        _box[i].setOrigin(sf::Vector2f(_box[i].getGlobalBounds().width / 2,
                                       _box[i].getGlobalBounds().height / 2));
        _box[i].setPosition(_data->_window->getSize().x / 2,
                            _data->_window->getSize().y / 2 - 350 + 75 * i);
        _box[i].setOutlineThickness(1);
        _box[i].setOutlineColor(sf::Color(40, 116, 166, 240));
        ...
        _text[i].setCharacterSize(25);
        _text[i].setPosition(_data->_window->getSize().x / 2 - 150,
                             _data->_window->getSize().y / 2 - 400 + 75 * i);
        _text[i].setFillColor(sf::Color::Black);
        ...
        _showbox[i].setFillColor(sf::Color::Black);
        _showbox[i].setPosition(_data->_window->getSize().x / 2 - 150,
                                _data->_window->getSize().y / 2 - 365 + 75 * i);
        _showbox[i].setString("");
    }
...
UpdateCourse::UpdateCourse(Data *data)
    : _data(data), _blink(1), _exitfocus(0), _submitfocus(0), _exitselected(0), _submitselected(0)
{
    _boxfocus[7] = {0};
}
...
AddStudent2::AddStudent2(Data *data)
    : _data(data),
      _blink(1),
      _exitfocus(0),
      _boxfocus(0),
