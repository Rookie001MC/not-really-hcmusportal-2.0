...
void LoginForm::Init()
{
    ...
    _loginformbox.setOrigin(sf::Vector2f(_loginformbox.getGlobalBounds().width / 2,
                                         _loginformbox.getGlobalBounds().height / 2));
    ...
    _profileicon.setOrigin(_profileicon.getLocalBounds().width / 2,
                           _profileicon.getLocalBounds().height / 2);
    _profileicon.setPosition(_data->_window->getSize().x / 2,
                             _data->_window->getSize().y / 2 - 270);
    ...
    _showusername.setPosition(_data->_window->getSize().x / 2 - 150,
...
void LoginForm::Update()
{
    ...
    (_exitfocus ? _exitbutton.setFillColor(sf::Color(0, 76, 153, 100))
                : _exitbutton.setFillColor(sf::Color(0, 76, 153, 200)));
    (_submitfocus ? _submitbutton.setFillColor(sf::Color(0, 76, 153, 100))
                  : _submitbutton.setFillColor(sf::Color(0, 76, 153, 200)));
    if (_exitselected)
    {
