...
ChangePass::ChangePass(Data *data)
    : _data(data),
      _oldpassfocus(0),
      _passwordfocus(0),
      _passwordfocus2(0),
...
void ChangePass::Init()
{
    ...
    _changeform.setOrigin(sf::Vector2f(_changeform.getGlobalBounds().width / 2,
                                       _changeform.getGlobalBounds().height / 2));
    ...
    _oldpassbox.setOrigin(sf::Vector2f(_oldpassbox.getGlobalBounds().width / 2,
                                       _oldpassbox.getGlobalBounds().height / 2));
    ...
    _oldpass.setPosition(_data->_window->getSize().x / 2 - 150,
                         _data->_window->getSize().y / 2 - 195);
    ...
    _showoldpass.setPosition(_data->_window->getSize().x / 2 - 150,
                             _data->_window->getSize().y / 2 - 150);
    ...
    _showpassword.setPosition(_data->_window->getSize().x / 2 - 150,
    ...
    _showpassword2.setPosition(_data->_window->getSize().x / 2 - 150,
                               _data->_window->getSize().y / 2 + 50);
...
void ChangePass::ProcessInput()
{
    ...
    while (_data->_window->pollEvent(event))
    {
        ...
        {
            _oldpassfocus   = (_oldpassbox.getGlobalBounds().contains(
                                 sf::Vector2f(sf::Mouse::getPosition(*_data->_window).x,
                                                sf::Mouse::getPosition(*_data->_window).y))
                                   ? 1
                                   : 0);
